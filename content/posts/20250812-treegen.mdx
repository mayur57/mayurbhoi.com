...
When the description is already in front of you, the friction to creating it for real should be zero. That’s the appeal. It’s not a general-purpose scaffolding tool; it’s a bridge between an idea and a working directory tree.
